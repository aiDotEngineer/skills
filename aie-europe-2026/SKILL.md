...
See `references/EXAMPLES.md` for 5 complete TS + Python recipes: topic index, semantic embed/cluster/retrieve, company leaderboard, multi-track day planner, and speaker social graph.
